...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupActionBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            // causes NullPointer, should call getSupportActionBar(), but don't know what to
            // extend/implement to get hold of it. No big issue not having the back button in the
            // Action bar.
        }
    }
    ...
    private void setupSimplePreferencesScreen() {
        ...
        daiVersionCheckbox.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                int defaultIndex;
                if (newValue == true) { // TODO: extract to method with R.array.XXX as parameter?
